...
public class AnalysisService {
    ...
    public PagedResponse<SessionAnalysisDto> getLongestSessions(Long userId, Pageable pageable) {
    ...
    public List<WebActivityAnalysisDto> getWebActivitiesMostTimeSpent(Long userId) {
            List<CheckpointEntity> checkpointEntities = checkpointRepository.findAllBySession_User_IdAndTimestampAfter(userId,
